...
namespace ElectronicObserver.Window
{
    public class QuestLib
    {
        ...
        static QuestLib()
        {
            ...
            //鎮守府正面の対潜哨戒を強化せよ
            AddQuest(280, "特注家具職人", "取得1-5BOSS A,S胜 4次");
            //「空母機動部隊」北方海域に進出せよ
            AddQuest(281, "改修資材x3,戦闘糧食x2", "使用空母旗舰取得3-5BOSS S胜,建议2cv1bb1ca2clt或者3cv1ca2clt 并且选择在磨血阶段做", 260, 230);
            
            //287 五航
            //「第五航空戦隊」珊瑚諸島沖に出撃せよ！
            AddQuest(287, "高速修復材x3,給糧艦「伊良湖」", "使用翔鶴,瑞鶴,朧,秋雲以及其他2只舰船取得5-2BOSS战S胜");
            //288 21战队
            //新編「第二一戦隊」北方へ出撃せよ！
            AddQuest(288, "戦闘糧食x1,プレゼント箱x1", "使用那智改二,足柄改二,多摩,木曾取得3-1BOSS战S胜,可以带其他船");
            //289 16战队
            //「第十六戦隊(第一次)」出撃せよ！
            AddQuest(289, "家具箱中x1,プレゼント箱x1", "使用足柄为旗艦,球磨,長良的舰队取得2-2BOSS战S胜,可以带其他船");
            //290秋刀鱼
            //鎮守府正面の対潜哨戒を強化せよ
            AddQuest(290, "特注家具職人", "");
            ...
            //精鋭艦隊演習
            AddQuest(310, "高速修復材x2，戦闘糧食x1", "本日取得7次演习胜利");
