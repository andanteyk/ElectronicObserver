	...
	public abstract class NotifierBase {
		...
		public bool LoadSound( string path ) {
			try {
                ...
                Utility.ErrorReporter.SendErrorReport(ex, string.Format(LoadResources.getter("api_req_map_start_1"), path));
				DisposeSound();
		...
		public void PlaySound() {
			try {
                ...
                Utility.Logger.Add(3, LoadResources.getter("NotifierBase_1") + ex.Message);
			}
		}
