namespace ElectronicObserver.Window {
	partial class FormShipGroup {
		...
		private void InitializeComponent() {
			...
			this.ShipView_ExpansionSlot.Width = 45;
			// 
			// ShipView_Aircraft1
			// 
			...
			this.MenuMember_Filter.Text = "列过滤(&F)...";
			...
			this.MenuMember_ColumnFilter.Text = "列的显示设定(&C)...";
			...
			this.MenuMember_SortOrder.Text = "自动排序设定(&S)...";
			...
			this.MenuGroup_Copy.Text = "分组拷贝(&C)";
			...
			this.MenuMember_CreateFromSelection.Text = "用选择的范围创建分组(&D)";
