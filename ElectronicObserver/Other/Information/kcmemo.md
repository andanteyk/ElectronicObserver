...
この状態で別の戦闘を行ったところ、「次のレベルまで」は何も表示されなかった(通常のLv99と同じ扱い)が、実経験値は 1000000 exp.に戻っていた。  
...
> 注: 経験値0の大破艦は、単艦で5-5に出撃した後戦闘結果を見る前に再読み込みすると入手することができる。
