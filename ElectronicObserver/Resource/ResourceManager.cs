	...
	public sealed class ResourceManager {
		...
		public bool Load() {
			...
			try {
                ...
                Utility.ErrorReporter.SendErrorReport(ex, LoadResources.getter("ResourceManager_1"));
                MessageBox.Show(LoadResources.getter("ResourceManager_2") + ex.Message, LoadResources.getter("ResourceManager_3"), MessageBoxButtons.OK, MessageBoxIcon.Error);
		...
		private static void LoadImageFromArchive( ImageList imglist, ZipArchive arc, string path, string name ) {
			...
			if ( entry == null ) {
                Utility.Logger.Add(3, string.Format(LoadResources.getter("ResourceManager_4"), path));
			...
			try {
                ...
                Utility.Logger.Add(3, string.Format(LoadResources.getter("ResourceManager_5")));
